    ...
    >
      <div className="flex flex-col h-full">
        <div>
          ...
          <p className="text-gray-300 text-base font-mono m-0">
            {experience.company}
          </p>
        </div>
        ...
        className="mt-4 w-full sm:w-fit self-stretch sm:self-start
                  bg-[#fe5042] text-white text-xs sm:text-sm
                  px-3 sm:px-4 py-1 rounded hover:bg-[#fc0865] transition"
      >
        Show Grades
      </button>
        )}
      ...
      {showGrades && (
        ...
        >
          ...
          >
                ...
                {experience.grades.map((g, i) => (
                  <React.Fragment key={i}>
                    <tr
                      className={
                        i % 2
                          ? "bg-gradient-to-r from-[#ff9720]/20 to-[#fc0865]/20"
                          : "bg-white/5"
                      }
                    >
                      ...
                      <td className="p-2">
                        {g.info && (
                          <button
                            ...
                            className="bg-gradient-to-r from-[#ff9720] to-[#fc0865] text-white
                    ...
                    {expandedRow === i && (
                      <tr>
                        <td
                          colSpan={3}
                          className="p-3 bg-[#1f1d26] whitespace-pre-line"
                        >
                          {g.info}
                        </td>
                      </tr>
            ...
            className="mt-6 w-full sm:w-fit block ml-auto
                      bg-[#fe5042] hover:bg-[#fc0865]
                      text-xs sm:text-sm px-3 sm:px-4 py-1
                      rounded transition text-white"
          >
            Close
          </button>
          </div>
...
const Experience = () => (
  ...
  >
    <div className="flex flex-col w-full max-w-7xl items-start justify-start">
      <motion.h2
        className="mb-0 sm:mb-10 xl:text-5xl md:text-4xl sm:text-3xl text-2xl
                   font-white !leading-normal"
